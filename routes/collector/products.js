...
.get('/:category/new/', function(req, res, next){
    ...
    .then((results)=>{
        res.redirect(`/collector/products/${category}/${results._id}/`);
    })
    .catch(next)
})
...
.get('/:category/:id/', function(req, res, next){
    ...
    .then((results)=>{
        ...
        if(product===null) return res.redirect(`/collector/products/${slug}/`);
...
.get('/:category/:id/images', function(req,res,next){
    ...
    .then(product=>{
        ...
        res.render('./collector/templates/products/images.njk')
    })
    .catch(next)
})
